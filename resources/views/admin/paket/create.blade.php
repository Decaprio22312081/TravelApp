    ...
    <div class="bg-white rounded-xl shadow p-6">
        <form method="POST" action="{{ route('admin.paket.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea name="itinerary" rows="3" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none @error('itinerary') border-red-500 @enderror">{{ old('itinerary') }}</textarea>
